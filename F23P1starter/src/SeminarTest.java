...
public class SeminarTest extends TestCase {
    ...
    public void testSerializationDeserialization() throws Exception {
        // Create a sample Seminar object
        Seminar originalSeminar = new Seminar(1, "Sample Seminar", "20230827", 60, (short) 1, (short) 2, 100, new String[]{"keyword1", "keyword2"}, "Sample description");

        // Serialize the Seminar object to a byte array
        byte[] serializedData = originalSeminar.serialize();

        // Deserialize the byte array to create a new Seminar object
        Seminar deserializedSeminar = Seminar.deserialize(serializedData);

        // Verify that the deserialized Seminar is equal to the original one
        assertEquals(originalSeminar.toString(), deserializedSeminar.toString());
    }
