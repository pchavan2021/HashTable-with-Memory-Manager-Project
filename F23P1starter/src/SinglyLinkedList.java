...
public class SinglyLinkedList<E> implements LList<E> {
     ...
     * sortedInsert
     * 
     * @param nodeToInsert takes a node
     * @param c takes a comparator 
     */
    public void insertInOrder(Node<E> nodeToInsert, Comparator<E> c) {
        E item = nodeToInsert.getData();
        Node<E> currentNode = head;
        Node<E> previousNode = null;
        // Locate insertion point while ( ( currentNode != null) &&
        while (currentNode != null && c.compare(item,
        ...
        if (previousNode != null) {
            ...
            // insert at the beginning nodeToInsert.setNext (firstNode);
